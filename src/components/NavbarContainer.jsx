        ...
        <div className="container-fluid" style={{backgroundColor:'inherit'}}>
            <div className="collapse navbar-collapse nav-wrapper" id="navbarSupportedContent">
                ...
                <div className="navbar-nav text-center me-auto mb-0">
                    <Link className="nav-home nav-item nav-link active" aria-current="page" to="/" onClick={() => handleClick()}>Home</Link>
                    <Link className="nav-about nav-item nav-link" to="/about" onClick={() => handleClick()}>About</Link>
                    <Link className="nav-favorites nav-item nav-link" to="/favorites" onClick={() => handleClick()}>Favorites</Link>
                    <Link className="nav-search nav-item nav-link d-md-none" to="/search" onClick={() => handleClick()}>Search</Link>
                </div>
